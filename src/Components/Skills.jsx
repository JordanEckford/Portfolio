 ...
 return (
  <div className="m-auto w-[90%] mt-28">
   ...
   <div className="animate-fade m-auto mt-10 grid grid-cols-2 lg:grid-cols-4 lg:w-[700px] justify-items-stretch gap-y-4 gap-x-3 w-80 xl:w-[1000px] xl:justify-items-center">
    ...
    />
    <img
     className={`animate-slidebounce h-10 xl:h-20 xl:w-80 object-cover`}
     src="https://img.shields.io/badge/HTML5-E34F26?style=for-the-badge&logo=html5&logoColor=white"
     alt=""
    />
    <img
     className={`animate-slidebounce h-10 xl:h-20 xl:w-80`}
    ...
    <img
     ...
     alt=""
    />
    <img className={`animate-slidebounce h-10 xl:h-20 xl:w-80`} src="https://img.shields.io/badge/Express.js-404D59?style=for-the-badge" alt="" />
    <img
     className={`animate-slidebounce h-10 xl:h-20 xl:w-80`}
     src="https://img.shields.io/badge/Firebase-039BE5?style=for-the-badge&logo=Firebase&logoColor=white"
     alt=""
    />
    <img className={`animate-slidebounce  h-10 xl:h-20 xl:w-80`} src="/Phaser.png" alt="" />
    <img
     className={`animate-slidebounce h-10 xl:h-20 xl:w-80 object-cover`}
