export const Skills = () => {
 return (
  <div className="m-auto w-[80%]">
   <h2 className="mt-0 text-center text-3xl underline">Skills</h2>
   <div className="m-auto mt-5 grid grid-cols-2 xl:grid-cols-4 justify-items-stretch gap-y-2 gap-x-2 w-80 xl:w-[1000px] xl:justify-items-center">
    ...
    <img className="h-10 xl:h-20 xl:w-80" src="https://img.shields.io/badge/React_Router-CA4245?style=for-the-badge&logo=react-router&logoColor=white" alt="" />
    ...
    <img className="h-10 xl:h-20 xl:w-80" src="https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white" alt="" />
