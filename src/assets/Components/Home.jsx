...
export const Home = () => {
 return (
  <div className="animate-fade m-auto text-center mt-40 w-[80%]">
   ...
   <Link to="/projects">
    <button className="border-2 border-black p-5 rounded-md hover:bg-orange-200 duration-1000 animate-slideup2">Check out my work!</button>
   </Link>
